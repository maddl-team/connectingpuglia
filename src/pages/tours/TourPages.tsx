...
export function TourValleDItria() {
  ...
  return (
    <TourPage
      ...
      heroImg="/images/tours/valle-ditria-hero.webp"
...
export function TourWinePuglia() {
  ...
  return (
    <TourPage
      ...
      heroImg="/images/tours/wine-puglia-hero.webp"
...
export function TourSalento() {
  ...
  return (
    <TourPage
      ...
      heroImg="/images/tours/salento-hero.webp"
...
export function TourBaroquePuglia() {
  ...
  return (
    <TourPage
      ...
      heroImg="/images/tours/baroque-puglia-hero.webp"
...
export function TourFoodOliveOil() {
  ...
  return (
    <TourPage
      ...
      heroImg="/images/tours/food-olive-oil-hero.webp"
